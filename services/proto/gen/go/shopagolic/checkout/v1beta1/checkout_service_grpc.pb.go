...
func (c *checkoutServiceClient) Checkout(ctx context.Context, in *CheckoutRequest, opts ...grpc.CallOption) (*CheckoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/shopagolic.checkout.v1beta1.CheckoutService/Checkout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CheckoutService_Checkout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shopagolic.checkout.v1beta1.CheckoutService/Checkout",
	}
...
var CheckoutService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shopagolic.checkout.v1beta1.CheckoutService",
	...
	Metadata: "shopagolic/checkout/v1beta1/checkout_service.proto",
}
