...
import (
	...
	pb "github.com/demeero/shopagolic/services/proto/gen/go/shopagolic/recommendation/v1beta1"
...
const healthGRPCMethodName = "/shopagolic.recommendation.v1beta1.HealthService/Health"

func grpcServ(cfg grpcCfg, components rpc.Components, zlog *zap.Logger) func() {
	...
	pb.RegisterRecommendationServiceServer(grpcServ, rpc.NewRecommendation(components))
	pb.RegisterHealthServiceServer(grpcServ, rpc.NewHealth(components))
