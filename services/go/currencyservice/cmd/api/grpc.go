...
import (
	...
	pb "github.com/demeero/shopagolic/services/proto/gen/go/shopagolic/currency/v1beta1"
)

const healthGRPCMethodName = "/shopagolic.currency.v1beta1.HealthService/Health"

func grpcServ(cfg grpcCfg, currComponents rpc.CurrencyComponents, rClient *redis.Client, zlog *zap.Logger) func() {
	...
	pb.RegisterCurrencyServiceServer(grpcServ, rpc.NewCurrency(currComponents))
