...
import (
	...
	"github.com/demeero/shopagolic/paymentservice/internal/rpc"
...
const healthGRPCMethodName = "/shopagolic.payment.v1beta1.HealthService/Health"

func grpcServ(cfg grpcCfg, charger *payment.Charger, zlog *zap.Logger) func() {
	...
	pb.RegisterPaymentServiceServer(grpcServ, rpc.NewPayment(charger))
